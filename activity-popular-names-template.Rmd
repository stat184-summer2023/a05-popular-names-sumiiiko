...
My answer here.... 
The variable sex is not in the graph so this variable has to be transformed. To disregard sex in this graph, a group_by function would be needed containing name and year. Then a summarise function would contain the sum of count of each name per year.
...
My answer here.... 
Yes cases have been grouped by name, year and summarised to the sum of count of each name per year..
