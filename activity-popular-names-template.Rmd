...
My answer here.... 
The variable sex is not in the graph so this variable has to be transformed. To disregard sex in this graph, a group_by function would be needed containing name and year. Then a summarise function would contain the count.
...
My answer here.... 
Yes, all the cases excluding the names I picked.

##### Have cases been grouped and summarized within groups in any way?

My answer here.... 
Yes cases have been grouped and summarised to the 5 BabyNames I picked.
